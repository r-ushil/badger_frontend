...
class _ConeDrill extends State<ConeDrill> {
          ...
          builder: (context, snapshot) {
            return Stack(
              children: [
                ...
                Positioned(
                    top: leftHandResult.isEmpty ? 0 : leftHandResult["y"] * previewH  - 12,
                    left: leftHandResult.isEmpty ? 0 : leftHandResult["x"] * previewW  - 12,
                    child: const Icon(Icons.circle, color: Colors.cyan,)
                ),
                Positioned(
                    top: rightHandResult.isEmpty ? 0 : rightHandResult["y"] * previewH  - 12,
                    left: rightHandResult.isEmpty ? 0 : rightHandResult["x"] * previewW  - 12,
  ...
  void initState() {
    ...
    _initializeControllerFuture = controller.initialize().then((_) {
      previewH = MediaQuery.of(context).size.height - 90; //TODO: Calculator size of app bar at runtime
      ...
      controller.startImageStream((image) async {
        ...
        Tflite.runPoseNetOnFrame(
          ...
          if (results!.isNotEmpty && results[0]["keypoints"][9]["score"] > 0.5
